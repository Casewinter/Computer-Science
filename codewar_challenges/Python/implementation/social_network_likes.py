...
# Facebook and other pages. People can "like" blog posts,
...
print(likes(['Macky Stingray', 'Brian J. Mason', 'Nigel', 'Quincy Rosenkreutz', 'Galatea', 'Priscilla S. Asagiri', 'Daley Wong', 'Nene Romanova', 'Leon McNichol']))