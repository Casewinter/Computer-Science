# When you sign up for an account somewhere, 
# some websites do not actually store your password in their databases. 
# Instead, they will transform your password into something else
...
# tried using the same hashing algorithm and simply see if the password 
# hashes are the same
